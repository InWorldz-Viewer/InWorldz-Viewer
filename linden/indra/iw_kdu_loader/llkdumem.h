...
public:
	...
	S32 read(kdu_byte* buf, S32 num_bytes)
	{
		U32 num_out;
		num_out = num_bytes;
...
public:
	...
	bool write(const kdu_byte* buf, S32 num_bytes)
	{
		U32 num_out;
		num_out = num_bytes;
...
public:
	...
	bool get(S32 comp_idx, kdu_line_buf& line, S32 x_tnum);
...
private:
	...
	S32 num_components;
	S32 rows, cols;
	S32 alignment_bytes; // Number of 0's at end of each line.
	S32 precision[3];
