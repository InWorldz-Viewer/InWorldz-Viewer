...
bool LLKDUMemIn::get(S32 comp_idx, kdu_line_buf& line, S32 x_tnum)
{
	S32 idx = comp_idx - this->first_comp_idx;
	assert((idx >= 0) && (idx < num_components));

	x_tnum = x_tnum* num_components + idx;
	image_line_buf* scan = NULL; 
	image_line_buf* prev = NULL;
