...
# copy dlls, exes and such needed to run the viewer from within 
# VisualStudio. 
...
# Release, ReleaseSSE2, & ReleaseDebInfo Qt codecs folder
...
copy_if_different(
    ${plugintest_release_src_dir}
    "${CMAKE_CURRENT_BINARY_DIR}/ReleaseSSE2/llplugin/codecs"
    out_targets
    ${plugintest_release_files}
    )
set(all_targets ${all_targets} ${out_targets})
...
copy_if_different(
    ${plugintest_release_src_dir}
    "${CMAKE_CURRENT_BINARY_DIR}/../test_apps/llplugintest/ReleaseSSE2/codecs"
    out_targets
    ${plugintest_release_files}
    )
set(all_targets ${all_targets} ${out_targets})
    ...
    if(EXISTS ${debug_msvc8_redist_path})
        ...
        add_custom_command(
            ...
            ARGS
              ...
              ${CMAKE_CURRENT_SOURCE_DIR}/InWorldzDebug.exe.config
