...
{
	/* Leaving this here unchecked since we're not checking texture perms -- MC*/
...
{
	/* We allow people to export textures here, leaving this in case we ever go back on it -- MC
...
LLUUID LLObjectBackup::validateTextureID(LLUUID asset_id)
{
	...
	/* Leaving this here in case we want to check texture perms -- MC
