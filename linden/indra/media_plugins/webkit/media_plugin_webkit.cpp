...
#if KOKUA_LLQTWEBKIT_API_ADDNOFOLLOWSCHEME == 1	
		// register inworldz protocol as NoFollowScheme
		LLQtWebKit::getInstance()->addNoFollowScheme(mBrowserWindowId, "inworldz");
#endif
